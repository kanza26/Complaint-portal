  ...
  return (
    ...
    <div className="min-h-screen flex justify-center items-center">
      <div className="bg-[#D9D9D9] font-Poppins py-9 px-8 sm:px-12 md:px-20 lg:px-28 xl:px-36 rounded-3xl shadow-lg text-center w-6/12 sm:w-10/12 md:w-8/12 lg:w-6/12">
        <h1 className='text-xl font-bold mt-6 mb-20 sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl'>Login</h1>
        ...
        <label htmlFor="password" className="block text-lg mb-1 mt-2 text-left font-bold">
           Password:
        </label>
        <input
          type="text"
        ...
        <div className="mt-4 font-bold">
          Don't have an account? <a className='text-blue-900' href="/"> Register</a>
        </div>
      </div>
    </div>
    </>

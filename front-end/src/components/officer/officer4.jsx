...
export default class Officer4 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            uploadedImage: null,
    ...
    render() {
        return (
            <div className="application">
                ...
                <div className="flex flex-row h-screen gap-5">
                    ...
                    <div className="flex flex-col  mx-auto">
                        <h1 className="font-Poppins font-bold text-[#6E9794] text-center text-4xl my-14 sm:text-2xl sm:text-center sm:mx-auto">View Feedback on Resolved Complaints</h1>
                        ...
                        <div className="grid  grid-cols-3  gap-10 sm:grid-cols-1 ">
                            <a href='/'>
                                <div className='bg-[#6E9794] h-[330px] w-[270px] rounded-xl mx-auto px-10 sm:w-[230px] sm:px-5 py-8'>
                                    ...
                                    <div className="font-Poppins text-sm text-center font-bold text-white mt-5">Status: Completed</div>
                                </div>
                            </a>
                            <div className='bg-[#6E9794] h-[330px] w-[270px] rounded-xl mx-auto sm:w-[230px] sm:px-5 px-10 py-8'>
                                <div className="font-Poppins text-lg text-center font-bold text-white">Complaint#001: Road Accident in University Road</div>
                                <img src="https://www.shutterstock.com/image-photo/persons-hand-inserting-complaint-letter-260nw-1289075314.jpg" className="w-[190px] h-[141.93px] mt-4 object-cover" alt="complaint" />
                                <div className="font-Poppins text-sm text-center font-bold text-white mt-5">Status: Completed</div>
                            </div>
                            <div className='bg-[#6E9794] h-[330px] w-[270px] rounded-xl sm:w-[230px] sm:px-5 mx-auto px-10 py-8'>
                                <div className="font-Poppins text-lg text-center font-bold text-white">Complaint#001: Road Accident in University Road</div>
                                <img src="https://www.shutterstock.com/image-photo/persons-hand-inserting-complaint-letter-260nw-1289075314.jpg" className="w-[190px] h-[141.93px] mt-4 object-cover" alt="complaint" />
                                <div className="font-Poppins text-sm text-center font-bold text-white mt-5">Status: Completed</div>
                            </div>
                            {/* Include remaining items similarly */}
                        </div>
                    </div>
                </div>
            </div>
